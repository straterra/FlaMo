	...
	if (chart.options.data[0].dataPoints.length == 0) {
		...
		for (var i=0; i<temp_titles.length; i++) {
			...
			newdata.push({
				type: 'line',
				showInLegend: true,
				name: temptitles_pretty['Flashforge Dreamer'][temp_title],
				lineThickness: 2,
			...
			$('#tempforms').append(
				...
				'	<div class="col-xs-3"><h3 class="panel-title pull-left">' + temptitles_pretty['Flashforge Dreamer'][temp_title] + '</h3></div>\n' +
